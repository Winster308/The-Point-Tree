var systemComponents = {
    ...
    'info-tab': {
        ...
        <br>
        The Modding Tree <a v-bind:href="'https://github.com/Acamaeda/The-Modding-Tree/blob/master/changelog.md'" target="_blank" class="link" v-bind:style = "{'font-size': '14px', 'display': 'inline'}" >{{TMT_VERSION.tmtNum}}</a> 由 Acamaeda 和 FlamemasterNXF 制作
        <br>
		...
		<br>
		存档导入/导出文件代码来自 'The Mario Maker 2 Tree'
		<br>
		<br>
		Infinity Notation 由 unicodes 制作
		<br>
		<br>
		感谢 Pixabay 提供的升级/里程碑/可购买/成就音效
		<br>
		<br>
		感谢部分测试人员
		<br>
    ...
    'options-tab': {
        ...
        <table>
			...
			<tr>
				<td><button class="opt" onclick="changeNotation()">计数法: {{ getNotationName() }}</button></td>
                ...
                <td><button class="opt" onclick="updateAction()">动作模式 (不建议在移动设备上使用): {{ getActionMode() }}</button></td>
				</tr> 
        </table>`
    },
