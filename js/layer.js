...
for (let n = 1; n <= UPG_COUNT; n++) {
    let added = "";
    if ((n % 50 == 0) && n < 1000) added = " [奖励加成 - 后续升级所需时间缩短10%！]";

    upgDescriptions[n] =
        "将力量乘以 " + format(upgEffects[n], 2) + "倍。" + added;
}
...
addLayer("p", {
        ...
        "Upgrades": {
            content: [
                ["display-text", function() {
                    return "你拥有 <h2 style='color:#FFAA00;display:inline;'>" + notationChooser(player.points) + "</h2> 力量"
                        + "<br>力量/秒: " + notationChooser(tmp.pointGen);
                }],
                "blank",
                ["clickables", [1]],
                "blank",
        ...
        "Energy": {
            content: [
                ...
                ["display-text", function() {
                    ...
                    return "基础能量获取: <h2 style='color:#FFAA00;display:inline;'>" + notationChooser(player.points.add(1).log10().add(1).log(1.1).mul(player.p.points.add(1).log(1.1)).mul(mult).floor()) + "</h2> (受当前力量和飞升次数影响)"
                        + "<br>公式: log1.1(log10(力量))*log1.1(飞升次数)";
                }],
                "blank",
                ["display-text", function() {
    ...
    clickables: {
        11: {
            title() {
                return player.p.compactView ? "视图模式：最近5行 (开启)" : "视图模式：所有已解锁行 (关闭)";
            },
    ...
    tooltip() {
        ...
        if (player.points.lte("1e1500")) return "飞升显现了！不过，你要飞升吗..."
        if (player.points.lte("1e7500")) return "你进展不错！还有更多在等着你..."
    ...
    resource: "飞升次数", // Name of currency
    baseResource: "力量", // Name of resource prestige is based on
    ...
    milestones: {
        ...
        8: {
            requirementDescription: "e250K 力量",
        ...
        9: {
            requirementDescription: "e500K 力量",
            effectDescription: "‘更好的自动’购买项价格减半。",
        ...
        10: {
            requirementDescription: "e1M 力量",
            effectDescription: "+100% 飞升次数、能量",
        ...
        11: {
            requirementDescription: "e2M 力量",
            effectDescription: "将‘强化飞升’购买项的效果提升至 +80%。",
        ...
        12: {
            requirementDescription: "e4M 力量",
            effectDescription: "将‘疯狂飞升’购买项的效果提升至 +230%",
        ...
        13: {
            requirementDescription: "e8M 力量",
            effectDescription: "将‘更多！！’购买项的价格降低十倍",
        ...
        14: {
            requirementDescription: "e14M 力量",
            effectDescription: "将‘激增倍率’购买项的价格降低十倍",
        ...
        15: {
            ...
            effectDescription: "当掷出4,000个光环时，能量乘以1.5。",
        ...
        16: {
            ...
            effectDescription: "‘更伟大的飞升’购买项提升至 +40%",
        ...
        18: {
            ...
            effectDescription: "连击重置所需时间从150毫秒增加到10秒",
        ...
        19: {
            ...
            effectDescription() {
                ...
                if (hasMilestone("p",21) && (player.aura.totalRolls>75000)) mult = mult.mul(2)
                if (hasMilestone("p",21) && (player.points.gte("e15e6"))) mult = mult.mul(2)
                let des = "被动能量获取，虽然非常微弱。同时 +75% 能量。"
        ...
        21: {
            ...
            effectDescription: "当掷出20,000和75,000个光环时，能量获取翻倍。如果力量 >e15M，能量获取再翻倍",
    ...
    buyables: {
        11: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>已购买: " + getBuyableAmount(this.layer, this.id) + "<br>效果: 将光环幸运乘以 x" + notationChooser(buyableEffect(this.layer, this.id))
            },
            canAfford() {
            ...
            tooltip() {
                return "x4 光环幸运，大约相当于 x1.15 的倍率。"
            }
        },
        12: {
            title: "更好的自动",
            ...
            display() {
                ...
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>已购买: " + getBuyableAmount(this.layer, this.id) + "<br>效果: 要自动化升级，你需要 " + automationReqs[x.toNumber()] + "x >> " + automationReqs[x.toNumber()+1] + "x 升级成本才能自动购买。"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
            ...
            tooltip() {
                return "花费+效果: 1Mx (免费) -> 100x (1) -> 25x (2) -> 15x (4) -> 10x (10) -> 6x (50) -> 4x (500) -> 3x (5,000) -> 2.5x (100K) -> 2x (2M)。"
            }
        },
        13: {
            title: "激增倍率",
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>当你没有购买升级 " + (getBuyableAmount(this.layer, this.id)*50) + " 时，x" + notationChooser(buyableEffect(this.layer, this.id)) + " 力量倍率"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
            ...
            tooltip() {
                return "每次购买将升级上限增加50，倍率增加1 (首次购买从3开始)"
            }
        },
        14: {
            title: "更多！！",
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>可解锁的最大升级: " + buyableEffect("p",14).add(100)
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
        ...
        15: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>效果: +" + buyableEffect("p",15) + "% 飞升次数"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
        ...
        16: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>效果: +" + buyableEffect("p",16) + "% 飞升次数"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
        ...
        17: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>效果: +" + buyableEffect("p",17) + "% 飞升次数"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
        ...
        18: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>效果: +" + buyableEffect("p",18) + "% 飞升次数"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
        ...
        19: {
            ...
            display() {
                return "花费: " + notationChooser(tmp[this.layer].buyables[this.id].cost) + " 飞升次数。" + "<br>效果: +" + buyableEffect("p",19) + "% 飞升次数"
            },
            canAfford() {
                return player[this.layer].points.gte(this.cost())
            },
    ...
    prestigeButtonText() {
        ...
        return "达到 " + formatWhole(tmp.p.requires) + " " + tmp.p.baseResource + " 以飞升<br>(下次在 " + formatWhole(getNextAt("p")) + ")"
    },
});
...
const AURA_SUFFIXES = ["超级", "巨型", "终极", "欧米伽", "超能", "天体", "疯狂", "棱镜", "超验", "神级", "异界", "全能", "绝对"];
...
addLayer("aura", {
    ...
    tabFormat: [
        ["display-text", function() {
            ...
            let text = "<h2>光环倍率: " + activeMulti.toFixed(2) + "x</h2><br>";
            text += "幸运倍率: <b>x" + notationChooser(luckMulti, 2) + "</b><br><br>";
            text += "因为你掷出了 <b>" + player.aura.totalRolls + "</b> 个光环，你将获得 x"+ notationChooser((1+(player.aura.totalRolls/1000)),3) +" 幸运倍率。<br><br>";
    ...
    infoboxes: {
        main: {
            title: "欢迎来到光环小游戏！",
            body() { return "掷出不同稀有度的光环！越稀有的光环提供越稀有的加成……虽然很小。最稀有的光环会提升力量" },
        },
    },
    update(diff) {
                mult = new Decimal(1)
