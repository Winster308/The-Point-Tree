...
addLayer("c", {
        ...
        effectDescription() { // Optional text to describe the effects
            ...
            return "正在提升华夫饼产量 "+format(eff.waffleBoost)+"，并将冰淇淋上限提升至 "+format(eff.icecreamCap)
        },
        infoboxes:{
            coolInfo: {
                title: "背景故事",
        ...
        upgrades: {
            ...
            13: {
                ...
                fullDisplay: "只能在点数少于 7 时购买，并为你增加 7 点数。解锁一个秘密页签。"
            },
            22: {
                title: "这个升级不存在",
                description: "或者它存在？",
        ...
        buyables: {
            ...
            respecMessage: "你确定吗？重置这些不会有什么效果。",
            11: {
                ...
                display() { // Everything else displayed in the buyable button after the title
                    ...
                    return "花费：" + format(data.cost) + " 棒棒糖\n\
                    数量：" + player[this.layer].buyables[this.id] + "/4\n\
                    增加 + " + format(data.effect.first) + " 物品，并将东西乘以 " + format(data.effect.second)
                },
        ...
        hotkeys: [
            {key: "c", description: "C：重置以获取棒棒糖或其他", onPress(){if (canReset(this.layer)) doReset(this.layer)}},
            {key: "ctrl+c", description: "Ctrl+c：重置物品", onPress(){respecBuyables(this.layer)}, unlocked() {return hasUpgrade('c', '22')}}  ,
        ],
        ...
        tabFormat: {
            "f": {
                ...
                content:
                    ...
                    ["text-input", "thingy"],
                    ["display-text",
                        function() {return '我有 ' + format(player.points) + ' ' + player[this.layer].thingy + ' 点数！'},
            ...
            jail: {
                ...
                content: [
                    ...
                    "blank", ["display-text", "这是监狱，因为\"栏杆\"！太搞笑了！哈哈！"],["tree", testTree], 
                ],
            },
            illuminati: {
