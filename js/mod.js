...
let winText = `恭喜！你已到达终点并通关此游戏！如果你喜欢，可以加入我的 Discord 服务器以获取未来的抢先预览和更新通知。你也可以在 Discord 中留下评论或报告错误！目前就这些。~RD82`

// 如果你在某个层内添加了新函数，并且这些函数在被调用时有影响，请将它们添加到这里。
// （这里的只是示例，所有官方函数都已处理）
...
// 计算每秒点数！
// 基础收益为每秒 2 能量，乘以每个已购买升级的效果。
// upgEffects[n] = prevBoost^exp，其中 exp 从 1.1 开始，每次升级乘以 1.02。
...
// 你可以在此添加与层无关的变量，这些变量应存入 "player" 并保存，以及默认值
...
// 如果你有可能会被长 tick 时长破坏的内容，可以更改此项
function maxTickLength() {
	return(3600) 
}

// 如果需要撤销旧版本中的膨胀问题，请使用此项。如果版本早于修复该问题的版本，
// 你可以使用此函数限制他们当前的资源。
