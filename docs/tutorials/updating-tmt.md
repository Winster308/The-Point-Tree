...
本教程假设您已使用[入门教程](getting-started.md)，并且正在使用Github Desktop和VSCode进行模组开发。
...
3. 点击顶部中间显示“current branch: master”的位置，在出现的菜单底部，点击“choose a branch to merge into master”。
